			...
			Authtime.find({}, function(err, auth_ts){
				Time.find({}, function(err, times){
					...
					users.forEach(function(u){
						if (u.education_level == 'middle_school'){
							community.education.middle_school += 1
						}

						if (u.education_level == 'high_school'){
							community.education.high_school += 1
						}

						if (u.education_level == 'associates'){
							community.education.associates += 1
						}

						if (u.education_level == 'bachelors'){
							community.education.bachelors += 1
						}

						if (u.education_level == 'masters'){
							community.education.masters += 1
						}

						if (u.education_level == 'phd'){
							community.education.phd += 1
						}

						if (u.education_level == 'na'){
							community.education.na += 1
						}
